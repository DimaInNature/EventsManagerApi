namespace EMA.Persistence.Interfaces;
    ...
    where TEntity : class, IDatabaseEntity
{
    ...
    public Task<TEntity?> GetFirstOrDefaultAsync(Guid key, CancellationToken token = default);
    ...
    public Task<bool> CreateAsync(TEntity entity, CancellationToken token = default);
